...
typedef struct {
    //Each Compiler points back to the Compiler for the function that encloses it, all the way back to the root Compiler for the top-level code.
...
static void declareVariable() {
    ...
    // Verify that there are two variables with the same name in a scope
